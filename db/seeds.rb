...
french = AttributeItem.create!(attribute_type: "Cuisine", name: "French")
...
atlantian = AttributeItem.create!(attribute_type: "Cuisine", name: "Atlantian")
...
AttrListB2A32 = BusinessAttribute.create!(business_id: randerys.id, attribute_item_id: pets.id)
AttrListB2A33 = BusinessAttribute.create!(business_id: randerys.id, attribute_item_id: wheelchair_access.id)

AttrListB3A8 = BusinessAttribute.create!(business_id: mutton_man.id, attribute_item_id: american.id)
AttrListB3A10 = BusinessAttribute.create!(business_id: mutton_man.id, attribute_item_id: burgers.id)
AttrListB3A17 = BusinessAttribute.create!(business_id: mutton_man.id, attribute_item_id: godrics_hollow.id)
AttrListB3A21 = BusinessAttribute.create!(business_id: mutton_man.id, attribute_item_id: restaurant.id)
AttrListB3A27 = BusinessAttribute.create!(business_id: mutton_man.id, attribute_item_id: happy_hour.id)
AttrListB3A29 = BusinessAttribute.create!(business_id: mutton_man.id, attribute_item_id: full_bar.id)
AttrListB3A33 = BusinessAttribute.create!(business_id: mutton_man.id, attribute_item_id: wheelchair_access.id)

AttrListB3A8 = BusinessAttribute.create!(business_id: tea_house.id, attribute_item_id: american.id)
AttrListB3A10 = BusinessAttribute.create!(business_id: tea_house.id, attribute_item_id: burgers.id)
AttrListB3A17 = BusinessAttribute.create!(business_id: tea_house.id, attribute_item_id: godrics_hollow.id)
...
AttrListB3A33 = BusinessAttribute.create!(business_id: tea_house.id, attribute_item_id: wheelchair_access.id)

AttrListB3A8 = BusinessAttribute.create!(business_id: windburgs_wands.id, attribute_item_id: american.id)
AttrListB3A10 = BusinessAttribute.create!(business_id: windburgs_wands.id, attribute_item_id: burgers.id)
AttrListB3A17 = BusinessAttribute.create!(business_id: windburgs_wands.id, attribute_item_id: godrics_hollow.id)
AttrListB3A21 = BusinessAttribute.create!(business_id: windburgs_wands.id, attribute_item_id: restaurant.id)
AttrListB3A27 = BusinessAttribute.create!(business_id: windburgs_wands.id, attribute_item_id: happy_hour.id)
AttrListB3A29 = BusinessAttribute.create!(business_id: windburgs_wands.id, attribute_item_id: full_bar.id)
AttrListB3A33 = BusinessAttribute.create!(business_id: windburgs_wands.id, attribute_item_id: wheelchair_access.id)

AttrListB3A8 = BusinessAttribute.create!(business_id: brooms.id, attribute_item_id: american.id)
AttrListB3A10 = BusinessAttribute.create!(business_id: brooms.id, attribute_item_id: burgers.id)
AttrListB3A17 = BusinessAttribute.create!(business_id: brooms.id, attribute_item_id: godrics_hollow.id)
AttrListB3A21 = BusinessAttribute.create!(business_id: brooms.id, attribute_item_id: restaurant.id)
AttrListB3A27 = BusinessAttribute.create!(business_id: brooms.id, attribute_item_id: happy_hour.id)
AttrListB3A29 = BusinessAttribute.create!(business_id: brooms.id, attribute_item_id: full_bar.id)
AttrListB3A33 = BusinessAttribute.create!(business_id: brooms.id, attribute_item_id: wheelchair_access.id)

AttrListB3A8 = BusinessAttribute.create!(business_id: curious_cocktails.id, attribute_item_id: american.id)
AttrListB3A10 = BusinessAttribute.create!(business_id: curious_cocktails.id, attribute_item_id: burgers.id)
AttrListB3A17 = BusinessAttribute.create!(business_id: curious_cocktails.id, attribute_item_id: godrics_hollow.id)
...
AttrListB3A8 = BusinessAttribute.create!(business_id: racers.id, attribute_item_id: american.id)
AttrListB3A10 = BusinessAttribute.create!(business_id: racers.id, attribute_item_id: burgers.id)
AttrListB3A17 = BusinessAttribute.create!(business_id: racers.id, attribute_item_id: godrics_hollow.id)
AttrListB3A21 = BusinessAttribute.create!(business_id: racers.id, attribute_item_id: restaurant.id)
AttrListB3A27 = BusinessAttribute.create!(business_id: racers.id, attribute_item_id: happy_hour.id)
AttrListB3A29 = BusinessAttribute.create!(business_id: racers.id, attribute_item_id: full_bar.id)
AttrListB3A33 = BusinessAttribute.create!(business_id: racers.id, attribute_item_id: wheelchair_access.id)

AttrListB3A8 = BusinessAttribute.create!(business_id: hibbidy.id, attribute_item_id: american.id)
AttrListB3A10 = BusinessAttribute.create!(business_id: hibbidy.id, attribute_item_id: burgers.id)
AttrListB3A17 = BusinessAttribute.create!(business_id: hibbidy.id, attribute_item_id: godrics_hollow.id)
AttrListB3A21 = BusinessAttribute.create!(business_id: hibbidy.id, attribute_item_id: restaurant.id)
AttrListB3A27 = BusinessAttribute.create!(business_id: hibbidy.id, attribute_item_id: happy_hour.id)
AttrListB3A29 = BusinessAttribute.create!(business_id: hibbidy.id, attribute_item_id: full_bar.id)
AttrListB3A33 = BusinessAttribute.create!(business_id: hibbidy.id, attribute_item_id: wheelchair_access.id)

AttrListB3A8 = BusinessAttribute.create!(business_id: plenty_potions.id, attribute_item_id: american.id)
AttrListB3A10 = BusinessAttribute.create!(business_id: plenty_potions.id, attribute_item_id: burgers.id)
AttrListB3A17 = BusinessAttribute.create!(business_id: plenty_potions.id, attribute_item_id: godrics_hollow.id)
AttrListB3A21 = BusinessAttribute.create!(business_id: plenty_potions.id, attribute_item_id: restaurant.id)
AttrListB3A27 = BusinessAttribute.create!(business_id: plenty_potions.id, attribute_item_id: happy_hour.id)
...
review5.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review6.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review7.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review8.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review9.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review10.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review11.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review12.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review13.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review14.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review15.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review16.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review17.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review18.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review19.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review20.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review21.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review22.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review23.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review24.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review25.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review26.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review27.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review28.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review29.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review30.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review31.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review32.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review33.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review34.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review35.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review36.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review37.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review38.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review39.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review40.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review41.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review42.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review43.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review44.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review45.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review46.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review47.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review48.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review49.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
review50.image.attach(io: File.open("app/assets/images/cauldron.jpg"), filename: "cauldron.jpg" )
