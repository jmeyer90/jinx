...
# Seed AttributeItems
attr1 = AttributeItem.create(attribute_type: "Cuisinse", name: "Italian")
attr2 = AttributeItem.create(attribute_type: "Cuisinse", name: "Lebanse")
attr3 = AttributeItem.create(attribute_type: "Cuisinse", name: "Brunch")
attr4 = AttributeItem.create(attribute_type: "Cuisinse", name: "Ramen")
attr5 = AttributeItem.create(attribute_type: "Cuisinse", name: "Sushi")
attr6 = AttributeItem.create(attribute_type: "Cuisinse", name: "Pizza")
attr7 = AttributeItem.create(attribute_type: "Cuisinse", name: "French")
attr8 = AttributeItem.create(attribute_type: "Cuisinse", name: "American")
attr9 = AttributeItem.create(attribute_type: "Cuisinse", name: "Chinese")
attr10 = AttributeItem.create(attribute_type: "Cuisinse", name: "Burgers")
attr11 = AttributeItem.create(attribute_type: "Cuisinse", name: "Atlantian")
attr12 = AttributeItem.create(attribute_type: "Cuisinse", name: "Indian")
...
attr18 = AttributeItem.create(attribute_type: "BusinessType", name: "Wand Repair")
attr19 = AttributeItem.create(attribute_type: "BusinessType", name: "Potion Supplies")
attr20 = AttributeItem.create(attribute_type: "BusinessType", name: "Curse Removal")
attr21 = AttributeItem.create(attribute_type: "BusinessType", name: "Restaurant")
attr22 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Takeout")
attr23 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Reservations")
attr24 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Waiter Service")
attr25 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Outdoor Seating")
attr26 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Good for Groups")
attr27 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Happy Hour")
attr28 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Delivery")
attr29 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Full Bar")
attr30 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Wi-Fi")
attr31 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Good for Kids")
attr32 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Pets Allowed")
attr33 = AttributeItem.create(attribute_type: "MiscAttribute", name: "Wheelchair Accessible")
...
sbhB1H1 = BusinessOperationHour.create(business_id: business1.id, operation_hours_id: sunOpen.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business1.id, operation_hours_id: sunClose.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business1.id, operation_hours_id: monOpen.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business1.id, operation_hours_id: monClose.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business2.id, operation_hours_id: wedOpen.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business2.id, operation_hours_id: wedClose.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business2.id, operation_hours_id: thursOpen.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business2.id, operation_hours_id: thursClose.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business2.id, operation_hours_id: friOpen.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business2.id, operation_hours_id: friClose.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business3.id, operation_hours_id: friOpen.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business3.id, operation_hours_id: friClose.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business3.id, operation_hours_id: satOpen.id)
sbhB1H1 = BusinessOperationHour.create(business_id: business3.id, operation_hours_id: satClose.id)
